...
export async function sendTicketEmail({
  ...
  const signatureHtml = `
    <div style="margin-top: 20px; font-family: Arial, sans-serif; color: #666; text-align: center;">
      <img src="${process.env.NEXT_PUBLIC_LOGO_URL}" alt="Vitiket Logo" style="width: 150px; height: auto; margin-bottom: 30px;" />
  ...
  const emailContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f5f5f5; padding: 20px;">
      <div style="text-align: center; padding: 10px 0;">
        <img src="${process.env.NEXT_PUBLIC_SERVER_URL}/assets/images/logo-no-bg.png" alt="Vitiket Logo" style="width: 150px; height: auto;" />
      </div>

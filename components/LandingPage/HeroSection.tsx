    ...
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-primary py-20 overflow-hidden">
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-6xl md:text-7xl  lg:text-8xl font-bold tracking-tight mb-8 text-neutral-white leading-tight animate-fade-in-up delay-100">
            Where tech minds <br />{" "}
            <span className="decorated-text"> connect</span> and{" "}
